  ...
  return (
    <div>
      <header className="text-gray-600 body-font shadow-lg">
        <Link to="/">
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 hover:bg-purple-200">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
